    ...
    <section id="contacto" className="contact-section">
      <div className="container">
        <div className="contact-box">
          <h2 className="contact-title">Agenda con nosotros</h2>
          <p className="contact-subtitle">Analizamos tus procesos para identificar oportunidades. 30 minutos, sin compromiso.</p>
